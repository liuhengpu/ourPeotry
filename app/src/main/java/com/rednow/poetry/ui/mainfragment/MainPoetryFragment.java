...
import com.rednow.poetry.adapter.section.HeaderTagPoetrySelection;
import com.rednow.poetry.adapter.section.PoetryItemSelection;
...
public class MainPoetryFragment extends RxLazyFragment {
    ...
    private class TagChangeListener implements OnClickTagListener {
        ...
        public void OnClick(String tagName) {
            PAGE_INDEX_POETRY = 1;
            refreshLayout.setHeaderHeightPx(0);
