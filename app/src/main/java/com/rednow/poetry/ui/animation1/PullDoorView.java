package com.rednow.poetry.ui.animation1;
	...
	public void computeScroll() {
		...
		if (mScroller.computeScrollOffset()) {
			...
			if (mCloseFlag) {
				...
				//time is nice things what we are now going finish this time ,and wo are the same people form world fish man what can i do now
				//search some things is my good time
				//
			}
		}
	}
