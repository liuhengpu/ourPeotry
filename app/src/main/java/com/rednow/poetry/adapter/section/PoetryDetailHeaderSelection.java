...
public class PoetryDetailHeaderSelection extends StatelessSection {
   ...
   public void setResource(int  i){
        if(i==1){
            viewHolder.iv_play.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.iv_pause));
        }else {
            viewHolder.iv_play.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.iv_play));
        }
    ...
    public static class TopItemPoetryDetailHolder extends RecyclerView.ViewHolder {
   ...
   public headItemCallBack headItemCallBack;
    public void setInterface(headItemCallBack headItemCallBack){
        this.headItemCallBack = headItemCallBack;
    }
    public interface  headItemCallBack{

         void doread(String readstring);
    }
}
