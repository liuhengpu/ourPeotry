 ...
 */
package com.rednow.poetry.base;
...
import com.rednow.poetry.utils.FileUtils;
import com.rednow.poetry.utils.LogUtils;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        File file = new File(FileUtils.createRootPath(mContext) + "/log-Ancient/" + fileName);
